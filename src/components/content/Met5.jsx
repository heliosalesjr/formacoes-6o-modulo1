    ...
    >
            ...
            >
              <div className="max-w-3xl">
                ...
                <p className="text-sm md:text-base text-slate-100">
                  Ao final de cada Parte do livro, sugerimos uma Atividade com Metodologias Ativas para o professor realizar com a turma. Chamamos essas atividades de Pequenos Projetos Didáticos Ativos (PPDA). Essas atividades proporcionam aos estudantes a oportunidade de se envolverem na própria aprendizagem, desenvolvendo habilidades importantes como autonomia, argumentação, investigação e abertura ao novo.
                </p>
              </div>
            </motion.div>
          </>
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            <iframe
              src="/caderno_educador_6º_ano_-25-26.pdf#navpanes=0&toolbar=1"
