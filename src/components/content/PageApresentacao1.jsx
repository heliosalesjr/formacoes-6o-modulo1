      ...
      <div className="grid gap-8 md:grid-cols-3 items-stretch">
        ...
        <div className="md:col-span-2 space-y-6 flex flex-col justify-center">
          ...
          <p className="text-slate-700 text-lg leading-relaxed">
            Este curso sobre a aplicação da Coleção Aprendendo a Lidar com Dinheiro faz parte das ações de acompanhamento pedagógico promovidas pela BEĨ Educação, voltadas aos educadores e educadoras da Secretaria de Educação do Município do Rio de Janeiro que lecionam Matemática para turmas do 6º ano Carioca.
          </p>
